...
class CartControllerTest {
    ...
    void getCart_ShouldReturnCartPage() throws Exception {
        ...
        webTestClient.get()
                ...
                .value(body -> {
                    ...
                    org.assertj.core.api.Assertions.assertThat(body).contains("10000");
                });
    }
    ...
    void getCart_WhenPaymentServiceUnavailable_ShouldShowError() throws Exception {
        ...
        webTestClient.get()
                ...
                .expectBody(String.class)
                .value(body -> {
                    org.assertj.core.api.Assertions.assertThat(body).contains("Сервис платежей недоступен");
                });
    }
    ...
    void getCart_WhenInsufficientFunds_ShouldShowError() throws Exception {
        ...
        webTestClient.get()
                ...
                .expectBody(String.class)
                .value(body -> {
                    org.assertj.core.api.Assertions.assertThat(body).contains("Недостаточно средств");
                });
    }
